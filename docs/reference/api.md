...
| `enableMTLS` _boolean_ | EnableMTLS enables mutual TLS authentication for the Ray cluster.<br />When enabled, KubeRay will automatically create certificates and configure mTLS for all Ray nodes.<br />TODO: Move to namespace-scoped CA management for production |  |  |
